...
public struct SlideMenuOptions {
    ...
    public static var contentViewScale: CGFloat = 0.9888888 //0.96
    ...
    public static var animationOptions: UIView.AnimationOptions = [.transitionFlipFromTop, .transitionCurlDown, .showHideTransitionViews]
...
extension UIViewController {
    ...
    public func addLeftBarButtons(btns:[UIBarButtonItem]) {
        let leftButton: UIBarButtonItem = UIBarButtonItem(image: UIImage(named:"hamburger-menu-icon"), style: UIBarButtonItem.Style.plain, target: self, action: #selector(self.toggleLeft))
        var bs:[UIBarButtonItem] = btns
        bs.append(leftButton)
        navigationItem.leftBarButtonItems = bs
    }
